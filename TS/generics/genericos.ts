...
console.log(echoMelhorado('João').length) //inferindo tipo
...
const d2 = new Data1(5, 5, 2022)
console.log('Diferença entre datas: ',new DiferencaEntreDatas(d1, d2).executar())

// Desafio Classe Fila
// Atributo: fila (Array)
// Métodos: entrar, proximo, imprimir
class Fila<T extends number | string> { //Constraints - restrições ao tipo T
